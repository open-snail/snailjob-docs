...
<configuration scan="false">
    ...
    <!-- EasyRetry appender -->
    <appender name="EasyLogAppender" class="com.aizuda.easy.retry.client.common.appernder.EasyRetryLogbackAppender">
    </appender>
...
<log4j:configuration>
    ...
    <appender name="EasyRetryLog4jAppender"
              class="com.aizuda.easy.retry.client.common.appernder.EasyRetryLog4jAppender">
    </appender>
