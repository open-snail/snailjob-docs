...
## Snail Job v1.0.0(2024-05-14)
> 本期开始EasyRetry正式更名为Snail Job，版本号从1.0.0开始
1. RPC组件优化【**优化**】
2. 代码结构优化【**优化**】
3. 基于[soybeanjs](https://github.com/soybeanjs/soybean-admin) 对管理系统全面升级 【**新增**】
   > 1. 新增工作流看板 【**新增**】
   > 2. 机器列表【**新增**】
   > 3. 定时任务列表【**新增**】
   > 4. 工作流任务列表【**新增**】
...
参与者设计开发人员名单
1. [https://gitee.com/zhengweilins](https://gitee.com/zhengweilins)
2. [https://gitee.com/xlsea](https://gitee.com/xlsea)
3. [https://gitee.com/zsg1994](https://gitee.com/zsg1994)
4. [https://gitee.com/dhb52](https://gitee.com/dhb52)
5. [https://gitee.com/JavaLionLi](https://gitee.com/JavaLionLi)

## v3.2.0(2024-04-08)
1. 异常重试支持实时日志【**新增**】
2. 新增自定义添加表前缀【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I9A07I)
3. server与client交互路径裸漏 希望增加通信token校验【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I98BFQ)
4. 工作流支持看板能力【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I93NGB)
5. 实时日志合并功能【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I93NFY)
6. 支持常见数据库例如oracle sqlserver 【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8NNZM)
7. 优化秒级任务重复执行【**优化**】
8. 优化多数据源模块【**优化**】
...
2. 工作流支持任务节点手动停止能力【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I93NJG)
3. 工作流支持任务节点手动重试能力【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I93NJ8)
4. 支持两个同级方法重试【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I93NDG)
5. 重试支持传播机制【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I93N8O)
6. 管理后台，所有清空按钮无效，无法删除历史数据【**BUG**】[issues](https://gitee.com/aizuda/easy-retry/issues/I917H0)
...
## v2.6.0(2024-01-30)
1. 定时任务执行任务编排功能【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8HGNQ)
2. 工作流执行手动/自动运行、复制工作流、停止等功能【**新增**】
3. 任务调度支持失败重试【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8O5OX)
4. 新增定时任务实时日志功能【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8GUEJ)
5. dashboard Sql 优化 【**优化**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8NTGT)
6. 管理台组信息配置的分区下拉框无数据 【**BUG**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8P4VX)

参与者设计开发人员名单
1. [https://gitee.com/zhengweilins](https://gitee.com/zhengweilins)
2. [https://gitee.com/xlsea](https://gitee.com/xlsea)
3. [https://gitee.com/zsg1994](https://gitee.com/zsg1994)
4. [https://gitee.com/lizhongyuan3](https://gitee.com/lizhongyuan3)

## v2.5.0(2023-12-11)
1. 支持通过nginx代理 将应用代理到 ip/xxx/ 路径下访问【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8K6GV)
2. 任务调度新增手动暂停、取消、恢复执行中任务【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8GRJS)
3. 任务调度新增失败告警通知【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8GRJR)
4. Dashboard 添加任务调度数据展示【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8GRJP)
5. 支持namespace隔离不同业务线的应用 【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I85SPE)
6. 重试告警新增重试任务进入死信队列告警类型 【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8GRJU)
...
13. 定时清除调度任务的历史日志 【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8GROG)
14. 告警支持通知负责人配置【**新增**】[issues](https://gitee.com/aizuda/easy-retry/issues/I8GRK2)

参与者设计开发人员名单
1. [https://gitee.com/zhengweilins](https://gitee.com/zhengweilins)
2. [https://gitee.com/zuojunlin](https://gitee.com/zuojunlin)
3. [https://gitee.com/zsg1994](https://gitee.com/zsg1994)
...
1. 支持分布式任务调度【**新增**】
> 1.1 支持秒级任务【**新增**】<br/>
> 1.2 支持集群、广播、分片任务模式【**新增**】<br/>
> 1.3 支持丢弃、覆盖、并行阻塞策略【**新增**】<br/>
> 1.4 支持固定时间、CRON表达式(页面可直接生成CRON表达式) 间隔时间【**新增**】<br/>
> 1.5 支持失败重试【**新增**】<br/>
> 1.6 支持任务超时机制【**新增**】<br/>
> 1.7 简单易用的管理系统【**新增**】<br/>
> 1.8 高性能任务调度，同时支持动态水平扩展【**新增**】<br/>
> 1.9 同时执行 MYSQL、Mariadb、postgresSQL 三种数据库类型<br/>
> ....
2. 支持重试场景执行超时时间设置【**新增**】
...
参与者设计开发人员名单
1. [https://gitee.com/zorro215](https://gitee.com/zorro215)
2. [https://gitee.com/zhengweilins](https://gitee.com/zhengweilins)
3. [https://gitee.com/zuojunlin](https://gitee.com/zuojunlin)
4. [https://gitee.com/zsg1994](https://gitee.com/zsg1994)
...
### <EasyRetryIcon iconType='icon-shipin' /> Snail Job 发布 2.3.0 & 3.0.0 支持SpringBoot3.x等多个新功能
...
### <EasyRetryIcon iconType='icon-shipin' /> [Snail Job 发布 2.2.0 新增多个重要功能快来尝鲜吧](https://www.ixigua.com/i7273130003787678260/)
<br/>
