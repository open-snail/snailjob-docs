...
module.exports = {
    ...
    themeConfig: {
        ...
        repo: 'https://github.com/aizuda/easy-retry.git', // 导航栏右侧生成Github链接
        ...
        author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
            name: 'www.byteblogs.com', // 必需
            href: 'https://github.com/byteblogs168' // 可选的
        },
        ...
        footer: { // 页脚信息
            ...
            copyrightInfo: [
                ...
                ' | ',
                '<a href="http://beian.miit.gov.cn/" target=_blank>皖ICP备16014822号-7</a>',
                '</p>',
            ].join('')
        },
        htmlModules,
    ...
    plugins: [
        ...
        [
            ...
            {
                hm: '2c305d1f977ecf38bd04a352782d724b'
            }
        ],
